    ...
    <div className="shortCake-container">
      <div className="shortcake">
        ...
        <div className="short-cake-right">
          ...
          <p>
            At Shortcake Finance, we believe in maximizing your earning
            potential. By adding liquidity to our carefully curated pools, you
            can earn interest and additional rewards on your crypto assets. Our
            platform supports a wide variety of tokens, offering you the
            flexibility to choose the assets that best fit your strategy.
          </p>
      ...
      <div className="shortcake shortcake2">
        <div className="short-cake-right">
          ...
          <p>
            Markets go up, but they also go down. With Shortcake Finance, you
            can benefit from both directions. Our platform offers a
            user-friendly interface for shorting select coins, allowing you to
            earn more coins when prices move in your favor. Whether you're a
            seasoned trader or just starting, our tools make it easy to execute
